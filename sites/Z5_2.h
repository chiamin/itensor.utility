...
//
#ifndef __ITENSOR_Z5_H
#define __ITENSOR_Z5_H
...
class Z5Site
    ...
    Z5Site(Args const& args = Args::global())
        {
    ...
    Z5Site(int n, Args const& args = Args::global())
        {
        *this = Z5Site({args,"SiteNumber=",n});
        }
